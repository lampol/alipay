<?php
namespace lampol\pc\service;


use lampol\pc\AlipayTradePagePayRequest;
use lampol\pc\AlipayTradeQueryRequest;
use lampol\pc\AlipayTradeRefundRequest;
use lampol\pc\AlipayTradeFastpayRefundQueryRequest;
use lampol\pc\AlipayTradeCloseRequest;
use lampol\common\AopClient;
/* *
 * 功能：支付宝电脑网站支付
 * 版本：2.0
 * 修改日期：2017-05-01
